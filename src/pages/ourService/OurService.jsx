  ...
  return (
    <div className="relative py-16 px-4 bg-white container mx-auto overflow-hidden">
      ...
      <div className="space-y-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center bg-white rounded-lg overflow-hidden relative" data-aos="fade-left">
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center bg-white rounded-lg overflow-hidden relative" data-aos="fade-right">
