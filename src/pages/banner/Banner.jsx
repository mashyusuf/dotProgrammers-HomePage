...
export default function Banner() {
  ...
  return (
    <div className="relative bg-white mt-10 mb-10  rounded-b-3xl container mx-auto shadow-xl p-6 md:p-10 lg:p-16 flex  md:flex-row items-center justify-between overflow-visible">
      ...
      {/* Text Section */}
      <div
        className="text-center  md:text-left max-w-lg mb-8 md:mb-0 md:mr-12"
      ...
      {/* Image Section */}
      <div
        className="relative w-full md:w-1/2 h-auto flex justify-center items-center overflow-visible"
        data-aos="fade-left"  // Animation for images
      >
